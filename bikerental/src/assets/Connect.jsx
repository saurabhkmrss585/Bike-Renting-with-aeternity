            ...
            >
                ...
                flex flex-col items-start '>
                            ...
                            '>
                                ...
                                <button className='text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-gray-600 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800 hover:bg-color-red-200'
                                    onClick={() => {
                                        if (spendAmount) {
                    ...
                    <React.Fragment>
                        ...
                        <div className='flex items-center justify-start '>
                            <div className='p-4 rounded-lg shadow-md w-64  flex flex-col items-center'>
                                <button className='text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-gray-600 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800 hover:bg-color-red-200'
                                    onClick={handleConnectClick} disabled={isLoading}
                                >
                                    {isLoading ? 'Connecting…' : 'Support'}
                                    {/* <AiOutlineSend size={20} /> */}
                                </button>
                            </div>
                        </div>
